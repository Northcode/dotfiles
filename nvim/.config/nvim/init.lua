...
vim.keymap.set("t", "<M-h>", "<C-\\><C-n><C-w><C-h>", { desc = "Move focus to the left window" })
vim.keymap.set("t", "<M-l>", "<C-\\><C-n><C-w><C-l>", { desc = "Move focus to the right window" })
vim.keymap.set("t", "<M-j>", "<C-\\><C-n><C-w><C-j>", { desc = "Move focus to the lower window" })
vim.keymap.set("t", "<M-k>", "<C-\\><C-n><C-w><C-k>", { desc = "Move focus to the upper window" })
...
-- emacs legacy binds
vim.keymap.set("", "<c-x><c-b>", "<c-^>", { desc = "quickly switch to previous [buffer]" })
